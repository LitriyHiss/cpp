...
### файл, содержащий реализацию функций для работы с книгами
![файл, содержащий реализацию функций для работы с книгами](./img/bookcpp.png)

Тут нечего пояснять, все предельно просто ;D
